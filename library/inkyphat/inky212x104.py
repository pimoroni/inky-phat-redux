...
class Inky212x104:
    ...
    def _v2_update(self, buf_black, buf_red):
        ...
        0xA5, 0x89, 0x10, 0x00, 0x00, 0x00, 0x00, # LUT0 - Black 
        0xA5, 0x19, 0x80, 0x00, 0x00, 0x00, 0x00, # LUT1 - White
        0xA5, 0xA9, 0x9B, 0x00, 0x00, 0x00, 0x00, # LUT2 - Red
        0xA5, 0xA9, 0x9B, 0x00, 0x00, 0x00, 0x00, # LUT3 - Red
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, # LUT4 - VCOM
        0x0F, 0x0F, 0x0F, 0x0F, 0x02, # Phase 0
